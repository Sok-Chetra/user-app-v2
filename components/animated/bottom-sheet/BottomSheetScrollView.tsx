...
import Animated, { AnimatedProps, AnimatedScrollViewProps, runOnJS, useAnimatedScrollHandler, useAnimatedStyle, useSharedValue, withSpring, withTiming } from 'react-native-reanimated'
import BackDrop from './BackDrop';

interface BottomSheetProps extends AnimatedProps<AnimatedScrollViewProps> {
    snapTo: string;
